...
/homes/pst_prd/tools/sparkms/sparkms/commands/analysis/spectrum_ions_annotation.py -spectra '/user/pst_prd/pride/parquets/spectra/' -o '/user/pst_prd/pride/parquets/spectra_ions/' > compute_ions.log 2>&1 &

...
/homes/pst_prd/tools/sparkms/sparkms/commands/converters/json_to_parquet.py -d 'peptide' -i '/user/pst_prd/pride/assays/' -o '/user/pst_prd/pride/parquets/peptides' > convert_peptides.log 2>&1 &

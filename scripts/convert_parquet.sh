...
/homes/pst_prd/tools/sparkms/sparkms/commands/converters/json_to_parquet.py json-to-parquet -i '/user/pst_prd/pride/assays/' -d 'spectra' -o '/user/pst_prd/pride/parquets/spectra' > convert_spectra.log 2>&1 &

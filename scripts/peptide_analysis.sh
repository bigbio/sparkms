...
/homes/pst_prd/tools/sparkms/sparkms/commands/analysis/peptide_summary.py -psm '/user/pst_prd/pride/parquets/spectra_ions/' -pep  '/user/pst_prd/pride/parquets/peptides/' \
